...
class JavaScriptPropTypesTargetLanguage extends TargetLanguage_1.TargetLanguage {
    ...
    constructor(displayName = "JavaScriptPropTypes", names = ["javascript-prop-types"], extension = "js") {
    ...
    emitTypes() {
        ...
        this.forEachTopLevel("none", (type, name) => {
            if (type instanceof Type_1.PrimitiveType) {
                ...
                if (type.kind === "array") {
                    this.ensureBlankLine();
                    this.emitLine("export const ", name, " = PropTypes.arrayOf(", this.typeMapTypeFor(type.items), ");");
                }
                else {
                    this.ensureBlankLine();
